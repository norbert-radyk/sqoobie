...
trait GroupBySignatures {
  ...
  def groupBy[T1, T2, T3, T4](
    ...
    new GroupQueryYield[Product4[T1, T2, T3, T4]](
      this,
      () => List(e1, e2, e3, e4)
    )
  ...
  def groupBy[T1, T2, T3, T4, T5](
    ...
    new GroupQueryYield[Product5[T1, T2, T3, T4, T5]](
      this,
      () => List(e1, e2, e3, e4, e5)
    )
  ...
  def groupBy[T1, T2, T3, T4, T5, T6](
    ...
    new GroupQueryYield[Product6[T1, T2, T3, T4, T5, T6]](
      this,
  ...
  def groupBy[T1, T2, T3, T4, T5, T6, T7](
    ...
    new GroupQueryYield[Product7[T1, T2, T3, T4, T5, T6, T7]](
      this,
  ...
  def groupBy[T1, T2, T3, T4, T5, T6, T7, T8](
    ...
    new GroupQueryYield[Product8[T1, T2, T3, T4, T5, T6, T7, T8]](
      this,
