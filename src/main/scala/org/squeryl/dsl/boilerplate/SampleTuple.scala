...
object SampleTuple {
  def create(n: List[SelectElement], m: Array[OutMapper[_]]) =
    m.length match {
      ...
      case 10 =>
        new STuple10[Any, Any, Any, Any, Any, Any, Any, Any, Any, Any](n, m)
      case 11 =>
        new STuple11[Any, Any, Any, Any, Any, Any, Any, Any, Any, Any, Any](
          n,
          m
        )
      case 12 =>
      ...
      case _ =>
        org.squeryl.internals.Utils.throwError("Tuple23 is not supported")
    }
}

class STuple1[T1](n: List[SelectElement], m: Array[OutMapper[_]])
    extends SampleTuple(n, m) {
  def _1 = _get[T1](1)
}

class STuple2[T1, T2](n: List[SelectElement], m: Array[OutMapper[_]])
