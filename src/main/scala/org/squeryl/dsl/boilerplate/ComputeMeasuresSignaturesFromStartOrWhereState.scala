...
import org.squeryl.dsl.fsm.{
  MeasuresQueryYield,
  QueryElements,
  ComputeStateStartOrWhereState
}
...
trait ComputeMeasuresSignaturesFromStartOrWhereState {
  ...
  ): ComputeStateStartOrWhereState[Product8[T1, T2, T3, T4, T5, T6, T7, T8]] =
  ...
  def compute[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15](
    ...
    new MeasuresQueryYield[Product15[
      T1,
      T2,
      T3,
      T4,
  ...
  def compute[
  ...
  ): ComputeStateStartOrWhereState[Product16[
    T1,
    T2,
    T3,
    T4,
    ...
    new MeasuresQueryYield[Product16[
      T1,
      T2,
      T3,
      T4,
  ...
  def compute[
  ...
  ): ComputeStateStartOrWhereState[Product17[
    T1,
    T2,
    T3,
    T4,
    ...
    new MeasuresQueryYield[Product17[
      T1,
      T2,
      T3,
      T4,
  ...
  def compute[
  ...
  ): ComputeStateStartOrWhereState[Product18[
    T1,
    T2,
    T3,
    T4,
    ...
    new MeasuresQueryYield[Product18[
      T1,
      T2,
      T3,
      T4,
  ...
  def compute[
  ...
  ): ComputeStateStartOrWhereState[Product19[
    T1,
    T2,
    T3,
    T4,
    ...
    new MeasuresQueryYield[Product19[
      T1,
      T2,
      T3,
      T4,
  ...
  def compute[
  ...
  ): ComputeStateStartOrWhereState[Product20[
    T1,
    T2,
    T3,
    T4,
    ...
    new MeasuresQueryYield[Product20[
      T1,
      T2,
      T3,
      T4,
  ...
  def compute[
  ...
  ): ComputeStateStartOrWhereState[Product21[
    T1,
    T2,
    T3,
    T4,
    ...
    new MeasuresQueryYield[Product21[
      T1,
      T2,
      T3,
      T4,
  ...
  def compute[
  ...
  ): ComputeStateStartOrWhereState[Product22[
    T1,
    T2,
    T3,
    T4,
    ...
    new MeasuresQueryYield[Product22[
      T1,
      T2,
      T3,
      T4,
