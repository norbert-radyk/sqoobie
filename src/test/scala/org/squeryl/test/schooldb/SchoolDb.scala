...
class TestInstance(schema: SchoolDb) {
  ...
  val tournesol = professors.insert(
    new Professor("tournesol", 80.0f, Some(70.5f), 80.0f, Some(70.5f))
  )

  val offering1 = courseOfferings.insert(
    CourseOffering(
      groupTheory.id,
      tournesol.id,
  ...
  val offering2 = courseOfferings.insert(
    CourseOffering(
      groupTheory.id,
      tournesol.id,
